...
def build_instrument_context(
    ...
    elif ticker.upper().endswith(".VN") or (identity and identity.get("exchange") in ("VSE", "HNX", "HOSE", "UPCOM")):
        context += (
            " [QUY TẮC THỊ TRƯỜNG CHỨNG KHOÁN VIỆT NAM (HOSE/HNX/UPCoM)]: "
            "1. Chu kỳ thanh toán là T+2.5 (mua cổ phiếu thì chiều ngày T+2 mới có thể bán). Cần tính toán kỹ rủi ro kẹt hàng ngắn hạn. "
            "2. Biên độ dao động giá mỗi phiên: Sàn HOSE (+/- 7%), HNX (+/- 10%), UPCoM (+/- 15%). Mức giá đặt (Entry/Stop loss/Target) phải tuân thủ biên độ này. "
            "3. Thị trường cơ sở Việt Nam KHÔNG cho phép bán khống (No Short Selling); chỉ khuyến nghị MUA (Buy/Long) hoặc BÁN hạ tỷ trọng/chốt lời/cắt lỗ (Sell/Exit), không được khuyến nghị mở vị thế bán khống."
        )
    return context
