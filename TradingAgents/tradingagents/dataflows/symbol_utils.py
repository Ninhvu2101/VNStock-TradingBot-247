...
_ALIASES = {
    ...
    # Vietnam stock market (HOSE / HNX / VN30)
    "VNINDEX": "^VNINDEX", "VNI": "^VNINDEX",
    "HPG": "HPG.VN", "VNM": "VNM.VN", "FPT": "FPT.VN", "SSI": "SSI.VN",
    "VIC": "VIC.VN", "VHM": "VHM.VN", "VRE": "VRE.VN", "TCB": "TCB.VN",
    "MBB": "MBB.VN", "VPB": "VPB.VN", "ACB": "ACB.VN", "CTG": "CTG.VN",
    "BID": "BID.VN", "VCB": "VCB.VN", "MWG": "MWG.VN", "MSN": "MSN.VN",
    "GAS": "GAS.VN", "PLX": "PLX.VN", "POW": "POW.VN", "SAB": "SAB.VN",
    "VJC": "VJC.VN", "STB": "STB.VN", "TPB": "TPB.VN", "HDB": "HDB.VN",
    "SHB": "SHB.VN", "LPB": "LPB.VN", "GVR": "GVR.VN", "BCM": "BCM.VN",
    "BVH": "BVH.VN", "DGC": "DGC.VN", "PVD": "PVD.VN", "PVS": "PVS.VN",
    "VCI": "VCI.VN", "HCM": "HCM.VN", "VND": "VND.VN", "KDH": "KDH.VN",
    "NLG": "NLG.VN", "DXG": "DXG.VN", "DIG": "DIG.VN", "PDR": "PDR.VN",
    "KBC": "KBC.VN", "IDC": "IDC.VN", "REE": "REE.VN", "PC1": "PC1.VN",
    "DBC": "DBC.VN", "HAX": "HAX.VN", "DCM": "DCM.VN", "DPM": "DPM.VN",
    "VHC": "VHC.VN", "ANV": "ANV.VN",
}
...
def normalize_symbol(raw: str) -> str:
    ...
    if s in _ALIASES:
        ...
        and s.isalpha()
        and (
            os.environ.get("TRADINGAGENTS_DEFAULT_MARKET", "VN").upper() in ("VN", "VIETNAM")
        )
    ):
        canonical = f"{s}.VN"
    else:
